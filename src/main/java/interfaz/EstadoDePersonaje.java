...
public class EstadoDePersonaje {
	...
	public static void dibujarEstadoDePersonaje(Graphics g, int x, int y,
		...
		g.drawImage(Recursos.getBarraSalud(), x + 80, y + 26, drawBarra, ALTOSALUD,
				null);
		g.drawString(
		...
		g.drawString(
				String.valueOf(personaje.getEnergia()) + " / "
						+ String.valueOf(personaje.getEnergiaTope()), x + 132,
				y + 52);

		if (personaje.getExperiencia() == Personaje.getTablaDeNiveles()[personaje
				.getNivel() + 1]) {
			drawBarra = ANCHOBARRA;
		} else {
		...
		g.drawString(
				String.valueOf(personaje.getExperiencia())
						+ " / "
						+ String.valueOf(Personaje.getTablaDeNiveles()[personaje
								.getNivel() + 1]), x + 132, y + 70);
		g.setFont(new Font("Tahoma", Font.PLAIN, 10));
	...
	public static void dibujarEstadoDePersonaje(Graphics g, int x, int y,
		...
		g.setColor(Color.WHITE);
		g.setFont(new Font("Tahoma", Font.PLAIN, 10));
		g.drawImage(Recursos.getBarraSalud(), x + 80, y + 26, ANCHOBARRA, ALTOSALUD,
				null);
		g.drawString(
